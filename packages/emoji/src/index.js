...
module.exports =
require("../emoji/_commons/0.js")([
{
"ids": [2],
"modules":{

/***/ "../../../weflow/packages/webpack-plugin/lib/loaders/page-loader.js?appContext=demo&outputPath=..%2Fsrc%2Findex!./src/index.ts":
/*!*******************************************************************************************************************************************************!*\
  !*** /Users/chyizheng/workspace/weflow/packages/webpack-plugin/lib/loaders/page-loader.js?appContext=demo&outputPath=..%2Fsrc%2Findex!./src/index.ts ***!
  \*******************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./index.ts */ "./src/index.ts")
...
"use strict";
__webpack_require__.r(__webpack_exports__);
// panel[0]=0 代表：表情面板第一个表情取data.id==0，panel[5]=6 代表：表情面板第6个表情取data.id==6 同理,panel只维护数据源,雪碧图在less中维护 
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _emoji_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./emoji_data */ "./src/emoji_data.ts");
/* harmony import */ var _emoji_panel_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./emoji_panel_data */ "./src/emoji_panel_data.ts");
...
const emotionMap = {};
const emotionNames = [];
_emoji_data__WEBPACK_IMPORTED_MODULE_0__["default"].forEach(item => {
  emotionMap[item.id] = item;
  emotionNames.push(item.cn);
});
const emotions = []; // 对应顺序的表情名称

_emoji_panel_data__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(id => emotions.push(emotionMap[id]));
Component({
  options: {
  ...
  lifetimes: {
    attached() {
      ...
      const areaWidth = systemInfo.windowWidth; // 这里的 45 为虚拟的表情宽度
  ...
  methods: {
    ...
    parseEmoji: _parser__WEBPACK_IMPORTED_MODULE_2__["parseEmoji"],
...
/*!***********************!*\
  !*** ./src/parser.ts ***!
  \***********************/
/*! exports provided: parseEmoji */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseEmoji", function() { return parseEmoji; });
/* harmony import */ var _emoji_data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./emoji_data */ "./src/emoji_data.ts");
// @ts-ignore

const emotionMap = {};
_emoji_data__WEBPACK_IMPORTED_MODULE_0__["default"].forEach((item, index) => {
  if (item.cn) {
...
"entries": [["../../../weflow/packages/webpack-plugin/lib/loaders/page-loader.js?appContext=demo&outputPath=..%2Fsrc%2Findex!./src/index.ts",0]]
},
]);
